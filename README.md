...
- [`docs/NOTES.md`](docs/NOTES.md) — notes on MCP internals from building this server
- [`docs/MVP_SPEC.md`](docs/MVP_SPEC.md) / [`docs/V2_SPEC.md`](docs/V2_SPEC.md) — design specs
